export const environment = {
  ...
  //LabaikEndpoint: 'https://localhost:44334/api/',
  LabaikEndpoint: 'https://lbaik.tameercloud.com/api/',
  labaikphoto: 'https://lbaik.tameercloud.com',
  ...
  printConfig: {
    ...
    styles: [
      '.customReport{@page{margin:0}, *{letter-spacing: 0.33px !important}}',
      '*{font-family: Cairo; }',
      ...
      '.collapsible-wrapper {border-inline-start: 1px dashed #ccc;margin-inline-start: 25px;} node-icon-wrapper {position: relative;} node-icon-wrapper::after{content: "";position: absolute;top: 50%;inset-inline-start: 0;width: 90%;height: 1px;border: 1px dashed #ccc;}',
