  ...
  exportData() {
    ...
    for (let index = 0; index < this.ExcelprojectsDataSource.length; index++) {
      x.push({
        ...
        depit: this.ExcelprojectsDataSource[index].depit,
        credit: this.ExcelprojectsDataSource[index].credit,
        balance: this.CurrentBalanceNewExport(index,this.ExcelprojectsDataSource),
    ...
    x.push({
      ...
      notes: "الاجمالي",
      transactionDate: null,
      depit: this.totalexDepit,
      credit: this.totalexCredit,
      balance: this.totaltxt,
      typeName: null,
      journalNo: null,
      costCenterName: null,
    })
