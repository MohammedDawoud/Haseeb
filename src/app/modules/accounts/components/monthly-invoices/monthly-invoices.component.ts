...
showTable : boolean = false ;
  ...
  title: any = {
    ...
    sub: {
      ar:' متابعة المبيعات والارباح الشهري',
      en:'Follow Up Monthly Payments and Earns',
    },
  };
 ...
 GetOrganizationData() {
  ...
  RefreshData(){
    ...
    this._accountsreportsService.GetMonthlypaymentsandearns(formData).subscribe(data => {
      debugger
