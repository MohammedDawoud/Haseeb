...
export class CanceledPurchaseInvoicesComponent implements OnInit{
  ...
  constructor(private modalService: NgbModal,
    private canceledPurchaseService: CanceledSalesService,
  ...
  load_Suppliers: any;
  FillSuppliersSelect() {
    this.canceledPurchaseService.FillSuppliersSelect().subscribe(data => {
  ...
  RefreshData() {
    ...
    _voucherFilterVM.type = 1
    _voucherFilterVM.supplierId = this.data.filter.search_supplier;
    ...
    this.canceledPurchaseService.GetAllVouchersRetReport_Pur(obj).subscribe((data: any) => {
  ...
  exportData() {
    ...
    this.canceledPurchaseService.customExportExcel(x, "Follow up on canceled purchase invoices");
