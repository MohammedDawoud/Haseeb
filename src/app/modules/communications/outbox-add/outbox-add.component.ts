...
public outinbox :OutInBox;
  ...
  DeptList2: any;
    ...
    this._outinboxservice.FillDepartmentSelectByType(1).subscribe((data) => {
      debugger;
      this.DeptList1 = data;
  ...
  FillOutboxTypeSelect(type: any) {
    this._outinboxservice.FillOutboxTypeSelect(type).subscribe((data) => {
      this.outboxtype = data;
           ...
           if (this.control?.value[0] != null) {
            ...
            this.toast.success(
              ...
              this.translate.instant('Message')
                ...
                this.router.navigate(['/communications/Outbox']); 
