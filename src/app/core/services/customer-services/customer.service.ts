...
import { CustomerFileAdd } from '../../Classes/DomainObjects/CustomerFilesAdd';
import { CustomerSMS } from '../../Classes/DomainObjects/customerSMS';
import { CityVM } from '../../Classes/ViewModels/cityVM';
import { ContractsCollectionVM } from '../../Classes/ViewModels/ContractsCollectionVM';
import { ContractsVM } from '../../Classes/ViewModels/contractsVM';
import { CustomerFilesVM } from '../../Classes/ViewModels/customerFilesVM';
...
GetAllCustomers_Branch_Url=environment.apiEndPoint + 'customer/GetAllCustomers_Branch';
  ...
  FillCitySelectUrl = environment.apiEndPoint + 'City/FillCitySelect';
  ...
  FillCitySelect() {
    return this.http.get<any>(this.FillCitySelectUrl);
  }
  ...
  saveCustomerFiles(_CustomerFilesVM: CustomerFilesVM) {
    return this.http.post<any>(this.saveCustomerFilesUrl, _CustomerFilesVM);
  }

  saveCustomerFilesAdd(_CustomerFilesVM: CustomerFileAdd) {
    return this.http.post<any>(this.saveCustomerFilesUrl, _CustomerFilesVM);
  }

  saveFilesType(model: any) {
    return this.http.post<any>(this.saveFilesTypeURL, model);
  }

  getAllContractsBySearchCustomer(
    _ContractsVM: ContractsCollectionVM
  ): Observable<any> {
    return this.http.post(
      this.getAllContractsBySearchCustomerUrl,
      _ContractsVM
    );
  }
  ...
  saveCity(_cityVM: CityVM): Observable<any> {
    return this.http.post<any>(this.saveCityUrl, _cityVM);
  }

  saveCustomerSMS(_CustomerSMS: CustomerSMS): Observable<any> {
    return this.http.post<any>(this.SaveCustomerSMSUrl, CustomerSMS);
  }
