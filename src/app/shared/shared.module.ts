...
import { CustomerContractsAddComponent } from '../modules/accounts/components/customer-contracts/customer-contracts-add/customer-contracts-add.component';
...
@NgModule({
  declarations: [
    ...
    CustomerContractsAddComponent,
    CustomerContractsAddMainComponent,
